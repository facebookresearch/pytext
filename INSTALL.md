IMPORTANT: Currently only python3.6 is supported. If you have any other python3 installed, they might interfer with activating the virtual environment and pytext might fail to run because of that.
