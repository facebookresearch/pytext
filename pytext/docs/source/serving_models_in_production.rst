...
We also provide a `Docker image on Docker Hub <https://hub.docker.com/r/pytext/predictor_service_torchscript>`_ with this example, which you can freely use and adapt to your needs.
