...
def create_task(
    task_config, metadata=None, model_state=None, model=None, rank=0, world_size=1
):
    """
...
class TaskBase(Component):
    ...
    def from_config(
        ...
        Args:
            ...
            model: if this is provided, use this as the model directly rather than
                creating a model from config / model_state
        """
