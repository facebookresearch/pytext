...
ONNX_MODEL_WHITELIST = {
    "AssistantComputeDocModel",
    "AssistantContextualIntentSlotModel",
    "AssistantDocModel",
    "AssistantIntentSlotLiteModel",
    "AssistantIntentSlotModel",
    "AssistantWordTaggingModel",
    ...
    "EnsembleModel",
    "FLPersonalizedByteDocModel",
    "FairseqDecoupledModel",
    "FairseqModel",
    "FairseqModelEnsemble",
    "IntentSlotModel",
    "KdByteDocModel",
    "LMLSTM",
    "LiteLMLSTM",
    "MultiTaskWordTaggingModel",
    "NLGFairseqModel",
    "PairBiTransformer",
    "PersonalizedByteDocModel",
    "PersonalizedDocModel",
    "SeqNNModel",
    "SequenceTaggingModel",
    "SmartComposeLMLSTM",
    "SmartComposeLMLSTMKD",
    "TorchscriptableLiteLMLSTM",
    "WitShallowTaggingModel",
